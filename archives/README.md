...
- **fish**:
  ...
  - reason: The command environment differs slightly from bash and zsh, resulting in an inconsistent user experience. Discontinued for this reason.
  - replacement: zsh

- **aerospace**:
  - archived_time: 2025-10-30
  - reason: Frequent window switching bugs when using multiple monitors, and noticeable lag when managing many windows.
  - replacement: Raycast window management
